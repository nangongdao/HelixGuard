...
def migration_9(connection: sqlite3.Connection) -> None:
    connection.executescript(
        ...
        CREATE TABLE IF NOT EXISTS quality_daily (
            ...
            PRIMARY KEY (tenant_id, date, risk_category, prompt_version)
        );
    ...
    _ensure_column(connection, "policy_articles", "status", "TEXT NOT NULL DEFAULT 'published'")
    _ensure_column(connection, "policy_articles", "reviewed_by", "TEXT")
    _ensure_column(connection, "policy_articles", "reviewed_at", "TEXT")
