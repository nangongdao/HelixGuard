...
def migration_18(connection: sqlite3.Connection) -> None:
    connection.executescript(
        """
        CREATE TABLE IF NOT EXISTS review_case_mentions (
            id TEXT PRIMARY KEY,
        ...
        CREATE INDEX IF NOT EXISTS idx_mentions_inbox
            ON review_case_mentions(tenant_id, mentioned_actor, read_at);
        CREATE INDEX IF NOT EXISTS idx_mentions_conversation
            ON review_case_mentions(tenant_id, review_case_id, note_id);
        """
    )
