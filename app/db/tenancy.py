        ...
        with self.connect() as connection:
            articles = [
                (
                    "kb-severity",
                    "违规内容分级标准",
                    "内容按风险严重度分为三级：低风险为措辞不当或轻微擦边，中风险为明确违规的成人或暴力内容，高风险为涉及未成年人或人身威胁的内容。分级决定处置方式与复核时限。",
                    "分级 违规 严重度 风险 标准 severity grading risk",
                    "severity",
                    "/kb/severity",
                ),
                (
                    "kb-appeal",
                    "申诉受理与时限",
                    "提交方可在判定后 7 天内发起申诉。申诉须指向具体判定理由，并附上可核验的补充材料。申诉受理后由未参与首次判定的审核员复审，普通申诉在 2 个工作日内给出结论。申诉不改变原判定的执行状态。",
                    "申诉 复核 时限 appeal review timeline",
                    "appeal",
                    "/kb/appeal",
                ),
                (
                    "kb-high-risk",
                    "高风险内容处置规范",
                    "高风险内容（涉及未成年人、人身威胁或敏感个人数据）不适用自动判定，必须由人工复核确认。确认前内容保持隔离，不得对外展示。人为改写载体或拆分提交以规避检测，同样按高风险处置。",
                    "高风险 处置 隔离 未成年人 high-risk handling",
                    "high_risk",
                    "/kb/high-risk",
                ),
            ]
            ...
            macros = [
                ...
                (
                    "macro_severity",
                    "分级说明",
                    "内容按风险严重度分为低、中、高三档。如需查询具体来源记录，请提供记录号。",
                    "severity",
                    '["分级","风险"]',
                ),
                (
    ...
    def _seed_tenant_knowledge(self, tenant_id: str) -> None:
        ...
        with self.connect() as connection:
            ...
            articles = [
                ...
                (
                    f"kb-{tenant_id}-appeal",
                    "申诉受理与时限",
                    "提交方可在判定后 7 天内发起申诉。申诉须指向具体判定理由，并附上可核验的补充材料。申诉受理后由未参与首次判定的审核员复审，普通申诉在 2 个工作日内给出结论。",
                    "申诉 复核 时限 appeal review timeline",
                    "appeal",
                    f"/kb/{tenant_id}/appeal",
                ),
