...
const QUERY_DEFS = [
  ...
  { key: ["admin", "groups"], domain: "groups", path: () => "/api/admin/reviewer-groups" },
  { key: ["admin", "rules"], domain: "rules", path: () => "/api/admin/routing-rules" },
  { key: ["admin", "csat"], domain: "csat", path: () => "/api/admin/qa-spot-check-summary" },
  { key: ["admin", "cost-daily"], domain: "cost-daily", path: () => "/api/analytics/costs/daily" },
  { key: ["admin", "cost-agents"], domain: "cost-agents", path: () => "/api/analytics/costs/by_reviewer" },
