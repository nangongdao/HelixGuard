  ...
  build: {
    ...
    rollupOptions: {
      ...
      input: {
        ...
        policy: resolve(__dirname, "src/islands/policy-island.jsx"),
        appeal: resolve(__dirname, "src/islands/appeal-island.jsx"),
        ...
        "review-case-dialog": resolve(__dirname, "src/islands/review-case-dialog-island.jsx"),
